        ...
        <Container>
          ...
          >
            ...
            <p className="fs-5 text-muted">
              Kami ingin sekali mendengar dari Anda! Isi formulir di bawah ini,{" "}
              <br />
              dan mari kita bahas bagaimana kami dapat membantu Anda mencapai
              tujuan Anda.
            </p>
          </motion.div>
        </Container>
                ...
                <Card.Body className="p-4">
                  <form onSubmit={handleSubmit}>
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <label className="form-label text-gradient">
                          Masukkan email yang valid untuk mendapatkan respons.
                        </label>
                        <input
                          type="email"
                          className="form-control"
                      ...
                      <div className="mb-4">
                        <label className="form-label text-gradient">
                          Jelaskan detail atau persyaratan spesifik apa pun.
                        </label>
                        <textarea
                          className="form-control "
                          rows="4"
